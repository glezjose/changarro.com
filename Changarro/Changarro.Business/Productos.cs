...
namespace Changarro.Business
{
    ...
    public class Productos
    {
        ...
        /// <summary>
        /// Método para obtener productos por medio de búsqueda 
        /// </summary>
        /// <param name="cBusqueda">Cadena con el texto a buscar</param>
        /// <returns>Lista con los productos obtenidos de la búsqueda</returns>
        ...
        /// <summary>
        /// Método para verificar la existencia de productos
        /// </summary>
