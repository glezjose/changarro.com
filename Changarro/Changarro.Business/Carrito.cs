...
namespace Changarro.Business
{
    public class Carrito
    {
        ...
        /// <summary>
        /// Este método es para obtener el total de productos que existen el el carrito especificado.
        /// </summary>
        ...
        /// <summary>
        /// En este método se obtiene el total
        /// </summary>
        /// <param name="iIdCarrito"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Esta función elimina los elementos del carrito
        /// </summary>
