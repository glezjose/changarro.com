function CargarGraficaUsuarios(oUsuariosCompras) {
    ...
    var chart = am4core.create("ClientesCompras", am4charts.XYChart);
    chart.hiddenState.properties.opacity = 0; 

    chart.paddingRight = 40;

    chart.data = oUsuariosCompras;
    ...
    series.dataFields.valueX = "iTotalCompras";
    series.dataFields.categoryY = "cNombre";
